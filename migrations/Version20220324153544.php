...
final class Version20220324153544 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE contest (id INT AUTO_INCREMENT NOT NULL, game_id INT NOT NULL, winner_id_id INT DEFAULT NULL, start_date DATE NOT NULL, INDEX IDX_1A95CB5E48FD905 (game_id), INDEX IDX_1A95CB5FC53D4E9 (winner_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
